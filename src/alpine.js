/*
Modified to work with morphdom's benchmarks
 */
...
export function morph(from, toHtml, options) {
    ...
    // because it's an  function and if run twice, they would overwrite
    // each other.
    ...
    fromEl = from
    toEl = toHtml // I don't think this works? - Sam... createElement(toHtml)
